...
public class ContentFragment extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        if (args != null) {
            ...
            if (args.getCharSequence(KEY_TITLE).equals("Stream"))
            {


                Log.e("TAG", MainActivity.string);
                title.setText(MainActivity.string);
                //new JSONTask().execute("http://jsonparsing.parseapp.com/jsonData/moviesData.txt"); // пробовал от сервера по сети принимать JSON файл
